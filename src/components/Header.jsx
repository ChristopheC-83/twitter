...
export default function Header() {
  return (
    <div className="flex flex-col items-start justify-between h-full gap-y-8 pb-52">
      ...
      <button className="p-4 text-3xl font-bold bg-blue-500 border-white rounded-full flexMid hover:bg-blue-600">
