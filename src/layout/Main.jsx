...
export default function Main() {
  return (
    <div className="min-h-screen max-w-7xl bg-neutral-50 text-neutral-900 dark:bg-neutral-900 dark:text-neutral-50 flex mx-auto relative">
      ...
      <div className="hidden min-h-screen absolute top-0 bottom-0 left-0 sm:flex sm:w-28 sm:flex-col xl:w-72 p-4 xl:p-8 border-r-2 border-neutral-500">
        <Header />
      </div>
      {/* Menu pour smartphone en pieds de page */}
      <div className="h-24 fixed z-20 bg-neutral-50 dark:bg-neutral-900 bottom-0 left-0 right-0 sm:hidden p-4 flex justify-between items-center border-t-2 border-neutral-500">
        <Footer />
      </div>
